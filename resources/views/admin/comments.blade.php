                    ...
                    <div class="flex-1 min-w-0">
                        <div class="flex justify-between items-center">
                            ...
                            All({{ $comments->count() }}) | 
                                ...
                                <a href="#" class="text-blue-400 hover:text-blue-600">Published({{ $comments->where('status','approved')->count() }})</a> |
                                <a href="#" class="text-blue-400 hover:text-blue-600">Pending({{ $comments->where('status','pending')->count() }})</a>
                            </div>
                            <div class="flex">
