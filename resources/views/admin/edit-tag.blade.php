                    ...
                    <div class="flex flex-col">
                        <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                            <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                                ...
                                <form class="space-y-8 divide-y px-2 py-2 divide-gray-200" method="post" action="{{ route('tag.update',$tag->tag) }}">
                                        @csrf
                                            ...
                                            <div>
                                                <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                                                    <div class="sm:col-span-6">
                                                        ...
                                                        <div class="mt-1">
                                                            <input id="name" value="{{ $tag->tag }}" name="name" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block px-2 py-2 w-full sm:text-sm border border-gray-300 rounded-md" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>        
