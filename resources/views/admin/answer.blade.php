        ...
        <main class="flex-1">
            <div class="py-6">
                <div class="max-w-7xl flex items-center mx-auto px-4 sm:px-6 lg:px-8 mb-4">
                    <h1 class="text-2xl font-semibold text-gray-900 mr-3">Answer</h1>
                            ...
                            <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                                ...
                                <div class="flex ">
                                    <div class="flex flex-col items-center justify-center space-x-3 px-2">
                                        <div class="">
                                            <img class="h-12 w-12 rounded-full" src="https://ui-avatars.com/api/?name={{ $answer->user->name }}" alt="">
                                        </div>
                                    ...
                                    <div class="w-full ml-4">
                                        ...
                                        <div class="mt-2 text-sm text-gray-700 space-y-4">
                                            <a class="text-green-500" href="{{ route('show.question',$answer->question->id) }}">Q - {{ $answer->question->title }}</a>
                                        </div>
                                        <div class="mt-6 flex flex-col justify-between">
                                            <div class="flex justify-between mb-2">
                                                <div>
                                                    Question Tag : <span class="text-gray-400">{{ $answer->question->tag }} </span>
                                                </div>
                                                <div>
                                                    This question is 
                                                    <span class="bg-gray-500 px-4 py-2 text-white rounded-lg">{{ $answer->question->stage }}</span>
                                                </div>
                                            </div>
                                            <div class="flex w-full justify-between">
                                                <div class="px-6 py-4 whitespace-nowrap text-right w-full text-sm font-medium flex">
                                                    ...
                                                    Answer status - <span class="text-green-500"> &nbsp;{{ $answer->status }} </span>
                                                    </div>
                                                    ...
                                                    <p class="px-2 w-full flex items-center">
                                                        ...
                                                        <span>{{ $answer->count() }} </span> <small>&nbsp;answers</small>
                                                    </p>
                                                    <p class="px-2 w-full flex items-center">
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 text-green-500">
