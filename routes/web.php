...
Route::get('/settings/questions/edits/{id}',[SettingsController::class,'editQuestion'])->name('update.question');
Route::post('/settings/questions/edits/{id}',[SettingsController::class,'updateQuestion']);
Route::get('/settings/questions/deletes/{id}',[SettingsController::class,'deleteQuestion'])->name('delete.question');
...
Route::get('/settings/answers/edits/{id}',[AnswerController::class,'editAnswer'])->name('update.answer');
Route::post('/settings/answers/edits/{id}',[AnswerController::class,'updateAnswer']);
Route::get('/settings/answers/deletes/{id}',[SettingsController::class,'deleteAnswer'])->name('delete.answer');
